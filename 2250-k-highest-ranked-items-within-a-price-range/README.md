<h2><a href="https://leetcode.com/problems/k-highest-ranked-items-within-a-price-range/?envType=problem-list-v2&envId=24v5tzr5">2250. K Highest Ranked Items Within a Price Range</a></h2><h3>Medium</h3><hr><p>You are given a <strong>0-indexed</strong> 2D integer array <code>grid</code> of size <code>m x n</code> that represents a map of the items in a shop. The integers in the grid represent the following:</p>
